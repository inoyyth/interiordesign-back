...
class TT_Example_List_Table extends WP_List_Table {
    ...
    function prepare_items() {
        ...
        $inquiry_comment = $wpdb->get_results("SELECT * FROM wp_customer_inquiry ORDER BY date desc", ARRAY_A);
        // var_dump($inquiry_comment);die; 
        // var_dump($this->example_data);die;
...
function tt_add_menu_items(){
    add_menu_page('Customer Inquiry', 'Customer Inquiry', 'activate_plugins', 'tt_list_test', 'tt_render_list_page');
